...
export default function Header({playerData, setPlayerData}) {
  ...
  return (
    <Container>
    {/* <Navbar className = "d-flex justify-content-between align-items-center p-2" bg="dark" fluid="lg"> */}
    {active ?
      <Navbar className = "d-flex justify-content-between align-items-center p-2" bg="dark" fluid="lg">
    ...
    :      
      <Navbar className = "d-flex justify-content-center align-items-center p-2" bg="dark" fluid="lg">
